...
// ada uses write16(TSL2561_COMMAND_BIT | TSL2561_REGISTER_THRESHHOLDL_LOW , lowThreshold); //TSL2561_REGISTER_THRESHHOLDL_LOW  = 0x02,
...
if (ratio < 0.61){lux = 0.0224 * d0 - 0.031 * d1;}
if (ratio < 0.80){lux = 0.0128 * d0 - 0.0153 * d1;}
if (ratio < 1.30){lux = 0.00146 * d0 - 0.00112 * d1;}
if (ratio > 1.30){lux = 0.0;}
